...
export const PATTERNS = [
  ...
  // The lookahead requires a digit or an uppercase letter somewhere in the
  // run. Real keys are high-entropy base62 and always have one; lowercase
  // hyphenated English never does. Without it, any heading anchor containing
  // "ask-and-..." matched — a generated docs page tripped exactly that.
  { name: "OpenAI", re: /sk-(?=[A-Za-z0-9_-]*[0-9A-Z])[A-Za-z0-9_-]{16,}/g },
